...
public static class CreateSaleTestData
{
    ...
    public static CreateSaleCommand GenerateValidCommand(Guid customerId)
    {
        var faker = new Faker<CreateSaleCommand>()
            ...
            .RuleFor(s => s.CustomerId, f => customerId ) // usa o valor passado se houver
    ...
    /// <summary>
    /// Generates a valid User entity with realistic test data
    /// </summary>
    /// <param name="id">Optional: specify Id. If not provided, generates a new Guid</param>
